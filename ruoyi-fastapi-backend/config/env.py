...
class AiTavernSettings(BaseSettings):
    """
    AI Tavern settings.
    """
    ...
    ai_summary_every_n_turns: int = 20
    ai_recent_message_limit: int = 60
    ai_enable_summary: bool = True
...
class GetConfig:
    ...
    def get_ai_tavern_config(self) -> AiTavernSettings:
        """
        Get AI Tavern config.
        """
        return AiTavernSettings()
...
# AI Tavern配置
AiTavernConfig = get_config.get_ai_tavern_config()
# 日志配置
