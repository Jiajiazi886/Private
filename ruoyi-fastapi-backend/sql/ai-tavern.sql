...
CREATE TABLE IF NOT EXISTS ai_conversation (
  ...
  conversation_prompt LONGTEXT COMMENT 'conversation prompt',
  forced_memory LONGTEXT COMMENT 'forced memory',
...
CREATE TABLE IF NOT EXISTS ai_message (
  ...
  voice_profile_id BIGINT NULL COMMENT 'voice profile id',
  is_edited TINYINT(1) DEFAULT 0 COMMENT 'message edited flag',
  create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
